...
public class FichaController{
	...
	private List<FichaExercicio> fakeCarrinho = new ArrayList();
	...
	public String salvar(HttpSession sessao, ModelMap modelMap){
		...
		for (FichaExercicio fichaExercicio : carrinho) {
			if(cont == 0){
				...
				ficha = fichaExercicio.getFicha();
				System.out.println("¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨"+fichaExercicio.getFicha().getId());
	...
	public String atualizar(ModelMap modelMap, HttpSession sessao){
			...
			for (FichaExercicio fichaExercicios : fakeCarrinho) {
				fichaExercicioService.ExcluirFichaExercicio(fichaExercicios);
			}
